          ...
          child: BlocConsumer<SettingsBloc, SettingsState>(
            ...
            builder: (context, settingsState) {
              List<Function(bool)> yaumiSettingsEvents = [
                ...
                (val) =>
                    context.read<SettingsBloc>().add(TooggleTahajudEvent()),
                (val) =>
                    context.read<SettingsBloc>().add(TooggleRawatibEvent()),
                (val) => context.read<SettingsBloc>().add(TooggleDhuhaEvent()),
                (val) =>
                    context.read<SettingsBloc>().add(TooggleTilawahEvent()),
                (val) => context.read<SettingsBloc>().add(TooggleShaumEvent()),
                (val) =>
                    context.read<SettingsBloc>().add(TooggleSedekahEvent()),
                (val) => context.read<SettingsBloc>().add(TooggleDzikirEvent()),
                (val) => context.read<SettingsBloc>().add(TooggleTaklimEvent()),
                (val) =>
                    context.read<SettingsBloc>().add(TooggleIstighfarEvent()),
                (val) =>
                    context.read<SettingsBloc>().add(TooggleShalawatEvent()),
              ];
